...
set(gca,'yscale','log');
%export_fig -transparent replicate_dcfnet_plot1.pdf


%%
figure(2); clf;
plot(1:nEpoch,100*noproj_nonoise.testaccuracy_history,'.-','color',col(1,:));
hold on; grid on;
plot(1:nEpoch,100*proj_nonoise.testaccuracy_history,'.-','color',col(2,:));
plot(1:nEpoch,100*noproj_noise.testaccuracy_history,'.-','color',col(3,:));
plot(1:nEpoch,100*proj_noise.testaccuracy_history,'.-','color',col(4,:));
set(gca,'fontsize',28);
...
%export_fig -transparent replicate_dcfnet_plot2.pdf
